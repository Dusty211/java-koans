...
public class AboutEquality {
    ...
    public void equalsMethodCanBeChangedBySubclassesToTestsIfTwoObjectsAreEqual() {
        ...
        // Clearer way of explaining the below comment: For the class 'Object' the equals method tests
        // if two Object instances are the 'same.' When comparing Object equality, same? is checked. Not
        // with other subclass like Integer.
        // 
